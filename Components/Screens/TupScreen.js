...
const tupVariants = [
  { id: '1', name: '250 g Tup', price: 120, mrp: 140, image: require('../Images/ghee.jpg') },
  { id: '2', name: '500 g Tup', price: 220, mrp: 260, image: require('../Images/ghee3.jpg') },
  { id: '3', name: '1 kg Tup', price: 420, mrp: 500, image: require('../Images/ghee4.jpg') },
];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: scale(30) }}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Tup / तूप</Text>
        </View>

        {tupVariants.map(variant => {
          const qty = quantities[variant.id] || 1;
