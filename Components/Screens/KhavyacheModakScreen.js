...
const modakVariants = [
  { id: '1', name: '6 pcs Modak', price: 60, mrp: 75, image: require('../Images/modak.jpg') },
  { id: '2', name: '12 pcs Modak', price: 110, mrp: 140, image: require('../Images/modak.jpg') },
  { id: '3', name: '24 pcs Modak', price: 200, mrp: 260, image: require('../Images/modak.jpg') },
];

const KhavyacheModakScreen = () => {
  const navigation = useNavigation();

  const [quantities, setQuantities] = useState(
    modakVariants.reduce((acc, item) => {
      acc[item.id] = 1;
      return acc;
    }, {})
  );
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: scale(30) }}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Khavyache Modak / खाव्याचे मोदक</Text>
        </View>

        {/* Variants List */}
        {modakVariants.map(variant => {
          const qty = quantities[variant.id] || 1;
...
export default KhavyacheModakScreen;
