...
const paneerVariants = [
  ...
  },
  {
    ...
    price: 120,
    mrp: 140,
    image: require('../Images/paneer1.jpg'),
  },
  {
    id: '3',
    name: '1 Kg Paneer',
  ...
  {
    id: '4',
    name: '1 Kg Premium Paneer',
    price: 220,
    mrp: 250,
    image: require('../Images/paneer3.png'),
  },
];
...
const PaneerScreen = () => {
  ...
  const [quantities, setQuantities] = useState(
    paneerVariants.reduce((acc, item) => {
      acc[item.id] = 1;
      return acc;
    }, {})
  );
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: scale(30) }}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Paneer / पनीर</Text>
        </View>

        {/* Variants List */}
        {paneerVariants.map(variant => {
