...
const milkVariants = [
  { id: '1', name: '500 ml Bottle', price: 25, mrp: 30, image: require('../Images/milk250.jpg') },
  { id: '2', name: '1 Litre Pouch', price: 45, mrp: 55, image: require('../Images/milk500.jpg') },
  { id: '3', name: '2 Litre Pouch', price: 85, mrp: 100, image: require('../Images/milk1.jpg') },
];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: scale(30) }}>
        <Text style={styles.title}>Milk Products</Text>
