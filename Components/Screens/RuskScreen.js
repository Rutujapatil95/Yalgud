...
const RuskScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.name}>Rusk / रस्क</Text>
          ...
          return (
            <View key={variant.id} style={styles.variantCard}>
              ...
              <View style={styles.textContainer}>
                {/* Single row with name, profit circle, price, mrp */}
