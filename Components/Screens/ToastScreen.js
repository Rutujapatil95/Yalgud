...
const ToastScreen = () => {
  ...
  // Initialize quantities with 1 for each variant
  const [quantities, setQuantities] = useState(
    toastVariants.reduce((acc, item) => {
      acc[item.id] = 1;
      return acc;
    }, {})
  );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.name}>Toast / टोस्ट</Text>
          ...
          return (
            <View key={variant.id} style={styles.variantCard}>
              ...
              <View style={styles.textContainer}>
                {/* Row with name, profit circle, price, mrp */}
