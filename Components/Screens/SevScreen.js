...
const sevVariants = [
  { id: '1', name: 'Classic Sev', price: 15, mrp: 20, image: require('../Images/shev.jpg') },
  { id: '2', name: 'Spicy Sev', price: 18, mrp: 24, image: require('../Images/shev.jpg') },
  { id: '3', name: 'Garlic Sev', price: 20, mrp: 25, image: require('../Images/shev.jpg') },
];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: scale(30) }}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Sev / शेव</Text>
        </View>

        {/* Variants List */}
        {sevVariants.map(variant => {
