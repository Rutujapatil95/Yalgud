...
const shrikhandVariants = [
  { id: '1', name: '200g Shrikhand', price: 40, mrp: 50, image: require('../Images/khand1.jpg') },
  { id: '2', name: '500g Shrikhand', price: 80, mrp: 100, image: require('../Images/khand1.jpg') },
  { id: '3', name: '1kg Shrikhand', price: 150, mrp: 180, image: require('../Images/khand2.jpg') },
];

const ShrikhandScreen = () => {
  const navigation = useNavigation();

  const [quantities, setQuantities] = useState(
    shrikhandVariants.reduce((acc, item) => {
      acc[item.id] = 1;
      return acc;
    }, {})
  );
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: scale(30) }}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Shrikhand / श्रीखंड</Text>
        </View>

        {/* Variants List */}
        {shrikhandVariants.map(variant => {
          const qty = quantities[variant.id] || 1;
...
export default ShrikhandScreen;
