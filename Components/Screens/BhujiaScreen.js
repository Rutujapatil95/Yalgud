...
const bhujiaVariants = [
  { id: '1', name: 'Classic Chakli', price: 22, mrp: 28, image: require('../Images/chakli.jpg') },
  { id: '2', name: 'Spicy Chakli', price: 26, mrp: 32, image: require('../Images/chakli.jpg') },
  { id: '3', name: 'Chatpata Chakli', price: 24, mrp: 30, image: require('../Images/chakli.jpg') },
];
...
const BhujiaScreen = () => {
  ...
  const [quantities, setQuantities] = useState(
    bhujiaVariants.reduce((acc, item) => {
      acc[item.id] = 1;
      return acc;
    }, {})
  );
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: scale(30) }}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Chakli / चकली</Text>
        </View>

        {/* Variant Cards */}
        {bhujiaVariants.map(variant => {
          const qty = quantities[variant.id];
