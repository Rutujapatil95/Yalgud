...
const mithaiVariants = [
  { id: '1', name: '250 g Mix Mithai', price: 100, mrp: 120, image: require('../Images/mithai1.png') },
  { id: '2', name: '500 g Laddu', price: 190, mrp: 230, image: require('../Images/laddu.jpg') },
  { id: '3', name: '1 kg Soanpapdi', price: 360, mrp: 420, image: require('../Images/son.jpg') },
  { id: '4', name: '500 g Kaju Katli', price: 360, mrp: 420, image: require('../Images/kaju.jpg') },
];
...
const MithaiScreen = () => {
  ...
  const [quantities, setQuantities] = useState(
    mithaiVariants.reduce((acc, item) => {
      acc[item.id] = 1;
      return acc;
    }, {})
  );
  ...
  const handleAddToCart = (variant) => {
    ...
    navigation.navigate('PaymentScreen', { variant, quantity: qty });
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: scale(30) }}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Mithai / मिठाई</Text>
        </View>

        {mithaiVariants.map(variant => {
          const qty = quantities[variant.id] || 1;
