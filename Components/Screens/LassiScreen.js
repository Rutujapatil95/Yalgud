...
const lassiVariants = [
  { id: '1', name: '200 ml Lassi', price: 20, mrp: 25, image: require('../Images/lassi.jpg') },
  { id: '2', name: '500 ml Lassi', price: 40, mrp: 50, image: require('../Images/lassi1.jpg') },
  { id: '3', name: '1 Litre Lassi', price: 70, mrp: 90, image: require('../Images/lassi2.jpg') },
  { id: '4', name: '1.5 Litre Lassi', price: 100, mrp: 120, image: require('../Images/lassi3.jpg') },
];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: scale(30) }}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Lassi / लस्सी</Text>
        </View>

        {/* Variants List */}
        {lassiVariants.map(variant => {
          const qty = quantities[variant.id] || 1;
