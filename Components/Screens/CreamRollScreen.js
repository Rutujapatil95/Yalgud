...
const CreamRollScreen = () => {
  const navigation = useNavigation();

  const [quantities, setQuantities] = useState(
    creamRollVariants.reduce((acc, item) => {
      acc[item.id] = 1;
      return acc;
    }, {})
  );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.name}>Cream Roll / क्रीमरोल</Text>
...
export default CreamRollScreen;
